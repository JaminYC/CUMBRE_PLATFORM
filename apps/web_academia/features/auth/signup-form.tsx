...
const ROLES = [
  { id: "student", icon: <StudentIcon />, label: "Estudiante", desc: "Estudio en la academia" },
  { id: "teacher", icon: <TeacherIcon />, label: "Docente",    desc: "Dicto clases en la academia" }
];
    ...
    <main className="login-page">
      <header className="login-nav">
        <Link href="/" className="login-nav__logo">
          ...
          <img src="/brand/logo-bryce-grupo.png" alt="Academia Bryce" className="login-logo" draggable={false} />
        </Link>
