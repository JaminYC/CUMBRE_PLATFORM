...
const ROLES: RoleConfig[] = [
  ...
  },
  {
    ...
    headline: "Diseña el camino. Nosotros lo acompañamos.",
    desc: "Crea aulas, publica tus propios módulos y asigna lecciones por grupo. Mientras dictas clase, el campus mantiene a cada estudiante en su ruta — y te muestra quién necesita apoyo.",
    checks: ["Módulos y lecciones propias", "Seguimiento por estudiante al día", "Apoyo entre clases — tú enseñas"],
  ...
  },
  {
    ...
    desc: "Control de contenido, seguimiento académico y una sola vista de toda la institución.",
    checks: ["Gestión de cursos y temario", "Supervisión del contenido publicado", "Visibilidad de toda la academia"],
    cta: "Solicitar demo",
