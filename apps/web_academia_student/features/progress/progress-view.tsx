...
export function ProgressView() {
  ...
  return (
    <AppShell
      title="Progreso"
      description="Tus sesiones, tu dominio por tema y qué te conviene hacer ahora."
      breadcrumbs={[
    ...
    >
      <div className="page-grid">
        ...
        >
          <ul className="detail-list">
            ...
            <li>
              <strong>Última sesión:</strong> {latestSession?.status ?? "Todavía sin sesiones"}
            </li>
            <li>
      ...
      <ContentCard
        title="Tus sesiones"
        subtitle="Todo lo que has estudiado hasta ahora"
        accent="sand"
      >
