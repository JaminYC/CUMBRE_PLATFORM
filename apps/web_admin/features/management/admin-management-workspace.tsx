...
export function AdminManagementWorkspace() {
  ...
  if (resource.error || !resource.data || !overview) {
    return (
      <ErrorPanel
        message={resource.error ?? "No fue posible cargar los datos de gestion administrativa."}
  ...
  return (
    <AppShell
      ...
      description="Gestiona temas, lecciones, conceptos y enlaces del grafo manteniendo alertas de integridad accionables y explicables."
      breadcrumbs={[
        { label: "Panel administrativo", href: "/dashboard" },
        { label: "Espacio de gestion" }
      ]}
      headerActions={
    ...
    >
      ...
      <div className="workspace-grid" data-testid="admin-management-workspace">
        ...
        <ContentCard
          title="Gestion del grafo"
          subtitle="Agrega conceptos y relaciones para mantener el razonamiento guiado por grafo conectado con contenido real."
          accent="sun"
        >
          <div className="form-grid">
            <label className="field">
          ...
          <div className="form-grid">
            <label className="field">
              ...
              >
                <option value="">Selecciona un nodo origen</option>
                {nodes.map((node) => (
      ...
      <div className="workspace-grid workspace-grid--secondary">
        ...
        <ContentCard
          title="Inventario actual del grafo"
